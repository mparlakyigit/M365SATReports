  ...
  <br><tr>
    ...
    <td width="100%" cellpadding="7px 6px 7px 15px" style="background:#e5f5fa;padding:5pt 4pt 5pt 12pt;word-wrap:break-word">
      <div style="color:#222222;">
        <span style="color:#222; font-weight:bold;">Açýklama:</span>
        MFA Kullanmayan kullanýcýlar organizasyonunuz için tehlike oluþturmaktadýr.
      </div>
    </td>
  </tr>
</table>
...
$aciklama_yedi=echo 1 | ConvertTo-Html -As Table -PreContent '<table border=0 cellspacing=0 cellpadding=0 align="center" width="100%">
  ...
  <br><tr>
    ...
    <td width="100%" cellpadding="7px 6px 7px 15px" style="background:#e5f5fa;padding:5pt 4pt 5pt 12pt;word-wrap:break-word">
      <div style="color:#222222;">
        <span style="color:#222; font-weight:bold;">Açýklama:</span>
        Shared Mailbox Web Üzerinden oturum açamamasý gerekmektedir. False deðerine sahip bir SharedMailbox oturum açabiliyor demektir. <br>https://www.parlakyigit.net/shared-mailbox-hesabi-icin-oturum-acmayi-engellemek/
      </div>
    </td>
  </tr>
</table>
...
<tr>
    ...
    <td width="0"><p>Mehmet PARLAKYÝÐÝT<br>
